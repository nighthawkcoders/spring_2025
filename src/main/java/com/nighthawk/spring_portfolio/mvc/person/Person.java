...
public class Person implements Comparable<Person> {
    ...
    */
    ...
    public static Person[] init() {
        ...
        people.add(createPerson("Mirage Systems","mirage",  "mirage@mirage.tech", defaultPassword, "2", "", false, startingBalance, "01-01-0001", Arrays.asList("ROLE_ADMIN", "ROLE_USER", "ROLE_STUDENT")));
