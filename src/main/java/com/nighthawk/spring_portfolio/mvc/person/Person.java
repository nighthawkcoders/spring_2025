...
public class Person implements Comparable<Person> {
    ...
    */
    ...
    public static Person[] init() {
        ...
        final String miragePassword = dotenv.get("MIRAGE_PASSWORD");
        people.add(createPerson("Thomas Edison", "tobydaman", "toby@gmail.com",  adminPassword, "1", "/images/toby.png", true, startingBalance, "01-01-1840", Arrays.asList("ROLE_ADMIN", "ROLE_USER", "ROLE_TESTER", "ROLE_TEACHER")));
        ...
        people.add(createPerson("Mirage Systems","mirage",  "mirage@mirage.tech", miragePassword, "2", "", false, startingBalance, "01-01-0001", Arrays.asList("ROLE_ADMIN", "ROLE_USER", "ROLE_STUDENT")));
        // /images/mirage.png
