...
public class Person implements Comparable<Person> {
    ...
    */
    ...
    public static Person[] init() {
        ...
        people.add(createPerson("Thomas Edison", "toby@gmail.com", "123toby", "/images/toby.png", true, startingBalance, "01-01-1840", Arrays.asList("ROLE_ADMIN", "ROLE_USER", "ROLE_TESTER", "ROLE_TEACHER")));
        people.add(createPerson("Alexander Graham Bell", "lexb@gmail.com", "123lex", "/images/lex.png", true, startingBalance, "01-01-1847", Arrays.asList("ROLE_USER", "ROLE_STUDENT")));
        people.add(createPerson("Nikola Tesla", "niko@gmail.com", "123niko", "/images/niko.png", true, startingBalance, "01-01-1850", Arrays.asList("ROLE_USER", "ROLE_STUDENT")));
        people.add(createPerson("Madam Curie", "madam@gmail.com", "123madam", "/images/toby.png", true, startingBalance, "01-01-1860", Arrays.asList("ROLE_USER", "ROLE_STUDENT")));
        people.add(createPerson("Grace Hopper", "hop@gmail.com", "123hop", "/images/madam.png", true, startingBalance, "12-09-1906", Arrays.asList("ROLE_USER", "ROLE_STUDENT")));
        people.add(createPerson("John Mortensen", "jm1021@gmail.com", "123Qwerty!", "/images/jm1021.png", true, startingBalance, "10-21-1959", Arrays.asList("ROLE_ADMIN", "ROLE_TEACHER")));
